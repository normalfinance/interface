...
// ): OpenPosition[] => {
// 	const oracleGuardRails = normalClient.getStateAccount().oracleGuardRails;
...
// 			const perpMarket = normalClient.getPerpMarketAccount(position.marketIndex);

// 			const usdcSpotMarket = normalClient.getSpotMarketAccount(
// 				QUOTE_SPOT_MARKET_INDEX
// 			);

// 			const oraclePriceData = normalClient.getOracleDataForPerpMarket(
