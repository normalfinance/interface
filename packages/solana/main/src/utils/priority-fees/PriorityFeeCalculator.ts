...
function calculateCUPriceForTargetSolValue(
  ...
  txComputeUnits = NORMAL_TX_COMPUTE_UNIT_ESTIMATE
) {
...
export const NORMAL_TX_COMPUTE_UNIT_ESTIMATE = 600_000;
...
export const SANITY_CHECK_ABS_MAX_CU_PRICE = calculateCUPriceForTargetSolValue(
  ...
  NORMAL_TX_COMPUTE_UNIT_ESTIMATE
);
...
export class PriorityFeeCalculator {
  ...
  public static calculateCUPriceForTargetSolValue(targetSolValue: number, txComputeUnits?: number) {
