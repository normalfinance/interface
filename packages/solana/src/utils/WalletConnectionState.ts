  ...
  is(stateQuery: ConnectionStateString) {
    switch (stateQuery) {
      ...
      case 'AdapterConnected':
        return (
          (this.state & ConnectionStates.AdapterConnected) === ConnectionStates.AdapterConnected
        );
      case 'ClientConnected':
        return (this.state & ConnectionStates.ClientConnected) === ConnectionStates.ClientConnected;
      case 'BalanceLoaded':
        return (this.state & ConnectionStates.BalanceLoaded) === ConnectionStates.BalanceLoaded;
      case 'FullyConnected':
        return (this.state & ConnectionStates.FullyConnected) === ConnectionStates.FullyConnected;
