...
export const PRIORITY_FEE_SUBSCRIPTION_ADDRESS_STRINGS = PRIORITY_FEE_SUBSCRIPTION_ADDRESSES.map(
  (pubkey) => pubkey.toString()
); // Pre-Computed string versions of the addresses, to save on computation
