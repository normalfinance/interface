...
type ProposalItemSkeletonProps = StackProps & {
  variant?: 'vertical' | 'horizontal';
};

export function ProposalItemSkeleton({ variant = 'vertical', sx, ...other }: ProposalItemSkeletonProps) {
...
export function ProposalDetailsSkeleton({ ...other }: StackProps) {
  return (
    <Stack {...other}>
